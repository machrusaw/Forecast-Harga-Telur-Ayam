				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<form action="forecast.php" method="post" name="ubah_alpha">
    <div class="form-check form-check-inline">
      <input class="form-control" type="text" name="nilai_alpha" placeholder="Ganti Nilai Alpha" style="width: 400px; margin-right:10px">
      <input type="hidden" name="id_alpha" value="<?php echo $data_alpha['id_alpha']; ?>">
      <button class="btn btn-primary" type="submit" name="submit" value="Ganti Alpha">
        <i class="fa fa-pencil" aria-hidden="true"></i> Ganti Alpha
      </button>
    </div>
  </form>
						</div>
				...
				<div class="row">
					<div class="col-sm-9">
						<table class="table table-hover table-bordered" style="background-color:#fff">
							<tr style="background-color:#0174BE; color:#fff">
								<th>Bulan - Tahun</th>
								<th>Data Aktual</th>
						...
						<script>
							...
							data: [<?php
								...
								?>],
									...
									lineTension: 0.3,
									fill: false,
									borderColor: '#5533FF',  // Warna biru tua
									backgroundColor: '#5533FF',  // Warna biru tua
									pointBorderColor: '#5533FF',  // Warna biru tua
									pointBackgroundColor: '#5533FF',  // Warna biru tua
									pointRadius: 5,
									pointHoverRadius: 15,
									pointHitRadius: 30,
									pointBorderWidth: 2,
								...
								var dataSecond = {
									...
									lineTension: 0.3,
									fill: false,
									borderColor: '#FF8C00',  // Warna oranye
									backgroundColor: '#FF8C00',  // Warna oranye
									pointBorderColor: '#FF8C00',  // Warna oranye
									pointBackgroundColor: '#FF8C00',  // Warna oranye
									pointRadius: 5,
									pointHoverRadius: 15,
									pointHitRadius: 30,
									pointBorderWidth: 2
