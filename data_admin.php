		...
		<div class="container-fluid">
			...
			<div class="jumbotron">
				...
				<div style="margin-bottom: 10px;">
					<a class="btn btn-primary" href="tambah_admin.php"><i class="fa fa-pencil" aria-hidden="true" style="margin-right:5px"></i>Tambah Admin</a>
				</div>
					...
					while ($data = mysqli_fetch_assoc($resultquery)) {
						...
						<tr>
							...
							<td>
								...
								<button class="btn btn-info" type="submit" name="submit" value="Edit">
