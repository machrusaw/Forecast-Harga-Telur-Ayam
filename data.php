		...
		<div class="container-fluid">
			...
			<div class="jumbotron" style="background-color: #FDF7E4;">
				...
				<div style="margin-bottom: 10px;">
					<a class="btn btn-primary" href="tambah.php"><i class='bx bxs-add-to-queue' style="margin-right:5px;background-color: #0174BE;"></i>Tambah Data</a>
				</div>
				<table class="table table-hover table-bordered">
					...
					while ($data = mysqli_fetch_assoc($resultquery)) {
						...
						<tr style=" background-color: #fff;color: #000000;">
							...
							<button class="btn btn-primary" type="submit" name="submit" value="Edit">
							...
							<button class="btn btn-danger" type="submit" name="submit" value="Hapus">
